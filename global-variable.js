...
const ENEMY_COOL_DOWN = 10; // 敌人的攻击冷却时间
...
// 宠物
const PET_IDLE_IMAGE_NUMBER = 4; // 宠物闲置状态的图片数量
const PET_FOLLOW_DISTANCE = 50; // 宠物与主角的默认距离
const PET_FOLLOW_SPEED = 0.7; // 宠物跟随速度系数
const PET_FLOAT_AMPLITUDE = 5; // 宠物浮动幅度
const PET_FLOAT_SPEED = 0.05; // 宠物浮动速度
